let Mano;_235‍.w("./classes/Mano.js",[["default",["Mano"],function(v){Mano=v}]]);
let masAltaJ1=0;
let masAltaJ2=0;
...
function determinarGanador(){
    ...
    if (importanciaMano[manoJugador1.cadenaMano]>importanciaMano[manoJugador2.cadenaMano]){
        _235‍.g.console.log('Jugador 1 gana '+manoJugador1.cadenaMano);
    }
    else if (importanciaMano[manoJugador1.cadenaMano]<importanciaMano[manoJugador2.cadenaMano]){
        _235‍.g.console.log('jugador 2 gana '+manoJugador2.cadenaMano);
    }
    //Desempate Poker
  ...
  //  console.log(manoJugador1.CartaMasAlta,manoJugador2.CartaMasAlta);
   ...
   // console.log(valoresJ1 + ' '+ valoresJ2);
    for(let i=0;i<=4;i++){
       ...
       // console.log(valoresJ1+ ' '+valoresJ2);   
        _235‍.g.console.log(desempatarCartaMasAlta(valoresJ1,valoresJ2));
            break;
       }
       else 
       {
